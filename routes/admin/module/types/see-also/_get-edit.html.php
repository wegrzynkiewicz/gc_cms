...
<div class="row">
    <div class="col-lg-12">
        <form id="saveForm" action="<?=$request->uri?>" method="post">
            ...
            <?php else: ?>
                <ol id="sortable" class="sortable">
                    <?php foreach ($tabs as $tab): ?>
                        <?=render(ROUTES_PATH."/admin/module/types/see-also/_item.html.php", $tab)?>
                    <?php endforeach?>
                </ol>
                <script>
...
$(function(){
    ...
    var deleteUri       = '<?=$uri->make("/admin/module/types/see-also/item/delete.json")?>';
